    ...
    render() {
        const playButton = (
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="icon-play">
                    <circle cx="12" cy="12" r="10" className="icon-play--colored"/>
        ...
        const pauseButton = (
            <button
                ...
                onClick={this.handleClick}
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="icon-pause">
                    <circle cx="12" cy="12" r="10" className="icon-pause--colored"/>
